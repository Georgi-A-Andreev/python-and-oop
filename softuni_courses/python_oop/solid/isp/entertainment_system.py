...
class ConnectToPower:
    def connect_device_to_power_outlet(self, device):
        pass


class Television(ConnectViaHDMI, ConnectToPower, ConnectViaRCA):
...
class DVDPlayer(ConnectViaHDMI, ConnectToPower):
...
class GameConsole(ConnectViaHDMI, ConnectToPower, ConnectViaEthernet):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
...
class Router(ConnectToPower, ConnectViaEthernet):
    def connect_to_tv(self, television):
