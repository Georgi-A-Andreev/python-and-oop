...
class Car(models.Model):
    ...
    owner = models.ForeignKey(to=Owner, on_delete=models.CASCADE, related_name='cars', null=True, blank=True)


class Registration(models.Model):
    registration_number = models.CharField(max_length=10, unique=True)
    registration_date = models.DateField(null=True, blank=True)
    car = models.OneToOneField(to=Car, on_delete=models.CASCADE, null=True, blank=True)